...
describe("EngagementEventManager", () => {
  let ManagerClass;
  let manager;
  let req;
  ...
  beforeEach(() => {
    ...
    ManagerClass = proxyquire(
      "../../../../src/manager-layer/main/EngagementEvent/EngagementEventManager",
      {
  ...
  describe("constructor", () => {
    it("should initialize properties correctly", () => {
      ...
      expect(instance).to.have.property("objectName", "engagementEvent");
      expect(instance).to.have.property("modelName", "EngagementEvent");
