...
class GetRecommendationMcpController extends ReviewEngagementMcpController {
  constructor(params) {
    super("getRecommendation", "getrecommendation", params);
    this.dataName = "recommendation";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetRecommendationManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetRecommendationMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const getRecommendationMcpController = new GetRecommendationMcpController(
        mcpParams,
      );
      try {
        const result = await getRecommendationMcpController.processRequest();
        //return GetRecommendationMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
