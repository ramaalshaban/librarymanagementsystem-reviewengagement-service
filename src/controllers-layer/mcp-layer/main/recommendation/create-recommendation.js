...
class CreateRecommendationMcpController extends ReviewEngagementMcpController {
  constructor(params) {
    super("createRecommendation", "createrecommendation", params);
    this.dataName = "recommendation";
    this.crudType = "create";
  }

  createApiManager() {
    return new CreateRecommendationManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    description:
      "Create a new personalized or event-based recommendation for a user.",
    parameters: CreateRecommendationMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const createRecommendationMcpController =
        new CreateRecommendationMcpController(mcpParams);
      try {
        const result = await createRecommendationMcpController.processRequest();
        //return CreateRecommendationMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
