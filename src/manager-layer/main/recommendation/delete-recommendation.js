...
const { dbDeleteRecommendation } = require("dbLayer");

class DeleteRecommendationManager extends RecommendationManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbDeleteRecommendation function to delete the recommendation and return the result to the controller
    const recommendation = await dbDeleteRecommendation(this);
...
module.exports = DeleteRecommendationManager;
